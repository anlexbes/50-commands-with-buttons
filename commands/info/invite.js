...
module.exports = {
  ...
  run: async (client, message, args) => {
    let helpEmbed = new MessageEmbed()
      ...
      .setURL("https://discord.gg/2pGT7qPWVA")

      let button3 = new disbut.MessageButton()
      .setStyle('url')
      .setLabel('DEVLOPERS + SOURCE') 
      .setEmoji(`889822366945914890`)
      .setURL("https://www.youtube.com/channel/UCzAGQrMCsPo-NOqfFUW0Kjg")
       let button4 = new disbut.MessageButton()
      .setStyle('gray')
      .setID('button1')
      .setLabel('DEVLOPERS - ϏȢ ✦DEVIL NISHANT#7627 And  Eagle々Team-Devil#0070') 
      .setDisabled(true)
